...
公开 API：`markdown_to_blocks` / `blocks_to_markdown` / `doc_to_blocks` / `blocks_to_doc` / `markdown_to_doc` / `doc_to_markdown`。
...
- **文档编辑**：BlockNote 富文本编辑器、Markdown 持久化、自动保存（1.5s debounce）、媒体上传
